...
int main() {
    ...
    emp.employeeId = 123; //holds an int
    cout << "\n The employeeId is ::" << emp.employeeId
         << " and the salary is ::" << emp.salary;

    emp.salary = 987.654; // holds a double
    cout << "\nThe employeeId is ::" << emp.employeeId
         << " and the salary is ::" << emp.salary << "\n";
    ...
    std::variant<int, float, std::string> intFloatString; //type-safe union
